...
// The getArea method is abstract.
 ...
 class NewCircle extends NewShape {
    ...
    public NewCircle(double radius, double height) {
        this.radius = radius;
        super.height = height;
    }
  ...
  class NewRectangle extends Shape {
    ...
    public NewRectangle(String NewColor) {
        super.NewColor = NewColor;
    }

    public NewRectangle() {
    }
    public NewRectangle(String NewColor, double width, double height) {
        super.height = height;
        super.width = width;
        super.NewColor = NewColor;
    }
 ...
 class NewTriangle extends Shape {
    ...
    public NewTriangle(String NewColor) {
        super.NewColor = NewColor;
    }
